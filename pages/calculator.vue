      ...
      <v-stepper v-model="e1">
        ...
        <v-stepper-items>
          <v-stepper-content step="1">
            ...
            >
              <v-card-text>
                Masukkan jumlah persamaan (jumlah persamaan harus lebih dari nol)
                <v-img :src="require('~/assets/img/step1.png')" contain height="120px" />
              </v-card-text>
            </v-card>
          ...
          <v-stepper-content step="2">
            ...
            >
              <v-card-text>
                Masukkan nilai persamaan (kolom nilai tidak boleh kosong)
                <v-img :src="require('~/assets/img/step2.png')" contain height="240px" />
              </v-card-text>
            </v-card>
          ...
          <v-stepper-content step="3">
            ...
            >
              <v-card-text>
                Pastikan semua kolom sudah terisi, lalu klik hitung
                <v-img :src="require('~/assets/img/step3.png')" contain height="120px" />
              </v-card-text>
            </v-card>
